...
# 1. Check API Status
run_api_call "Check API Health" "GET" "/"

# 2. Save Inventory (One-time setup)
run_api_call "Initialize Inventory (ETL Process)" "GET" "/save_inventory"

# 3. Get All Categories
run_api_call "Fetch Product Categories" "GET" "/products/categories"

# 4. Get Top Products
run_api_call "Fetch Top Selling Products" "GET" "/products/top"

# 5. Get Products by Category
# We'll assume 'Running' exists from our generator script
run_api_call "Fetch Products in 'Running' Category" "GET" "/products/category/Running"

# 6. Get Product Details (Simulate picking a specific SKU)
...
run_api_call "Fetch Details for Item SKU-10001" "GET" "/products/SKU-10001"

# 7. Add Item to Cart
run_api_call "Add SKU-10001 to Cart (Qty: 2)" "POST" "/cart/add" \
